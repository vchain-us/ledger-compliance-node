...
goog.exportSymbol('proto.lc.schema.SafeItemExt', null, global);
 ...
 * @constructor
 */
proto.lc.schema.SafeItemExt = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.lc.schema.SafeItemExt, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.lc.schema.SafeItemExt.displayName = 'proto.lc.schema.SafeItemExt';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.lc.schema.SafeItemExt.prototype.toObject = function(opt_includeInstance) {
  return proto.lc.schema.SafeItemExt.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.lc.schema.SafeItemExt} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.lc.schema.SafeItemExt.toObject = function(includeInstance, msg) {
  var f, obj = {
    item: (f = msg.getItem()) && schema_pb.SafeItem.toObject(includeInstance, f),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.lc.schema.SafeItemExt}
 */
proto.lc.schema.SafeItemExt.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.lc.schema.SafeItemExt;
  return proto.lc.schema.SafeItemExt.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.lc.schema.SafeItemExt} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.lc.schema.SafeItemExt}
 */
proto.lc.schema.SafeItemExt.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new schema_pb.SafeItem;
      reader.readMessage(value,schema_pb.SafeItem.deserializeBinaryFromReader);
      msg.setItem(value);
      break;
    case 2:
 ...
 * @return {!Uint8Array}
 */
proto.lc.schema.SafeItemExt.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.lc.schema.SafeItemExt.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.lc.schema.SafeItemExt} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.lc.schema.SafeItemExt.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getItem();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      schema_pb.SafeItem.serializeBinaryToWriter
    );
  }
...
/**
 * optional immudb.schema.SafeItem item = 1;
 * @return {?proto.immudb.schema.SafeItem}
 */
proto.lc.schema.SafeItemExt.prototype.getItem = function() {
  return /** @type{?proto.immudb.schema.SafeItem} */ (
    jspb.Message.getWrapperField(this, schema_pb.SafeItem, 1));
};


/**
 * @param {?proto.immudb.schema.SafeItem|undefined} value
 * @return {!proto.lc.schema.SafeItemExt} returns this
*/
proto.lc.schema.SafeItemExt.prototype.setItem = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.lc.schema.SafeItemExt} returns this
 */
proto.lc.schema.SafeItemExt.prototype.clearItem = function() {
 ...
 * @return {boolean}
 */
proto.lc.schema.SafeItemExt.prototype.hasItem = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 */
proto.lc.schema.SafeItemExt.prototype.getTimestamp = function() {
 ...
 * @return {!proto.lc.schema.SafeItemExt} returns this
*/
proto.lc.schema.SafeItemExt.prototype.setTimestamp = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.lc.schema.SafeItemExt} returns this
 */
proto.lc.schema.SafeItemExt.prototype.clearTimestamp = function() {
 ...
 * @return {boolean}
 */
proto.lc.schema.SafeItemExt.prototype.hasTimestamp = function() {
  return jspb.Message.getField(this, 2) != null;
};
...
proto.lc.schema.ItemExt.toObject = function(includeInstance, msg) {
  var f, obj = {
    item: (f = msg.getItem()) && schema_pb.Item.toObject(includeInstance, f),
    timestamp: (f = msg.getTimestamp()) && google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f)
  };
...
proto.lc.schema.ItemExt.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new schema_pb.Item;
      reader.readMessage(value,schema_pb.Item.deserializeBinaryFromReader);
      msg.setItem(value);
      break;
    case 2:
      var value = new google_protobuf_timestamp_pb.Timestamp;
...
proto.lc.schema.ItemExt.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      schema_pb.Item.serializeBinaryToWriter
    );
  }
  f = message.getTimestamp();
  if (f != null) {
...
proto.lc.schema.ZItemExt.toObject = function(includeInstance, msg) {
  var f, obj = {
    item: (f = msg.getItem()) && schema_pb.ZItem.toObject(includeInstance, f),
    timestamp: (f = msg.getTimestamp()) && google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f)
  };
...
proto.lc.schema.ZItemExt.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new schema_pb.ZItem;
      reader.readMessage(value,schema_pb.ZItem.deserializeBinaryFromReader);
      msg.setItem(value);
      break;
    case 2:
      var value = new google_protobuf_timestamp_pb.Timestamp;
...
proto.lc.schema.ZItemExt.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      schema_pb.ZItem.serializeBinaryToWriter
    );
  }
  f = message.getTimestamp();
  if (f != null) {
...
/**
 * optional immudb.schema.ZItem item = 1;
 * @return {?proto.immudb.schema.ZItem}
 */
proto.lc.schema.ZItemExt.prototype.getItem = function() {
  return /** @type{?proto.immudb.schema.ZItem} */ (
    jspb.Message.getWrapperField(this, schema_pb.ZItem, 1));
};


/**
 * @param {?proto.immudb.schema.ZItem|undefined} value
