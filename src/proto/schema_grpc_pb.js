...
function serialize_immudb_schema_Ops(arg) {
  if (!(arg instanceof schema_pb.Ops)) {
    throw new Error('Expected argument of type immudb.schema.Ops');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_immudb_schema_Ops(buffer_arg) {
  return schema_pb.Ops.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var ImmuServiceService = exports.ImmuServiceService = {
  ...
  execAllOps: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: schema_pb.Ops,
    responseType: schema_pb.Index,
    requestSerialize: serialize_immudb_schema_Ops,
    requestDeserialize: deserialize_immudb_schema_Ops,
    responseSerialize: serialize_immudb_schema_Index,
    responseDeserialize: deserialize_immudb_schema_Index,
  },
  scan: {
