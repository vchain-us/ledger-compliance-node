...
interface IImmuServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
    ...
    execAllOps: IImmuServiceService_IExecAllOps;
    ...
    getReference: IImmuServiceService_IGetReference;
...
interface IImmuServiceService_IExecAllOps extends grpc.MethodDefinition<schema_pb.Ops, schema_pb.Index> {
    path: "/immudb.schema.ImmuService/ExecAllOps";
    requestStream: false;
    responseStream: false;
    requestSerialize: grpc.serialize<schema_pb.Ops>;
    requestDeserialize: grpc.deserialize<schema_pb.Ops>;
    responseSerialize: grpc.serialize<schema_pb.Index>;
    responseDeserialize: grpc.deserialize<schema_pb.Index>;
}
...
interface IImmuServiceService_IGetReference extends grpc.MethodDefinition<schema_pb.Key, schema_pb.Item> {
    path: "/immudb.schema.ImmuService/GetReference";
    requestStream: false;
    responseStream: false;
    requestSerialize: grpc.serialize<schema_pb.Key>;
    requestDeserialize: grpc.deserialize<schema_pb.Key>;
...
export interface IImmuServiceServer {
    ...
    execAllOps: grpc.handleUnaryCall<schema_pb.Ops, schema_pb.Index>;
    ...
    getReference: grpc.handleUnaryCall<schema_pb.Key, schema_pb.Item>;
...
export interface IImmuServiceClient {
    ...
    execAllOps(request: schema_pb.Ops, callback: (error: grpc.ServiceError | null, response: schema_pb.Index) => void): grpc.ClientUnaryCall;
    execAllOps(request: schema_pb.Ops, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: schema_pb.Index) => void): grpc.ClientUnaryCall;
    execAllOps(request: schema_pb.Ops, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: schema_pb.Index) => void): grpc.ClientUnaryCall;
    ...
    getReference(request: schema_pb.Key, callback: (error: grpc.ServiceError | null, response: schema_pb.Item) => void): grpc.ClientUnaryCall;
    getReference(request: schema_pb.Key, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: schema_pb.Item) => void): grpc.ClientUnaryCall;
    getReference(request: schema_pb.Key, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: schema_pb.Item) => void): grpc.ClientUnaryCall;
...
export class ImmuServiceClient extends grpc.Client implements IImmuServiceClient {
    ...
    public execAllOps(request: schema_pb.Ops, callback: (error: grpc.ServiceError | null, response: schema_pb.Index) => void): grpc.ClientUnaryCall;
    public execAllOps(request: schema_pb.Ops, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: schema_pb.Index) => void): grpc.ClientUnaryCall;
    public execAllOps(request: schema_pb.Ops, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: schema_pb.Index) => void): grpc.ClientUnaryCall;
    ...
    public getReference(request: schema_pb.Key, callback: (error: grpc.ServiceError | null, response: schema_pb.Item) => void): grpc.ClientUnaryCall;
    public getReference(request: schema_pb.Key, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: schema_pb.Item) => void): grpc.ClientUnaryCall;
    public getReference(request: schema_pb.Key, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: schema_pb.Item) => void): grpc.ClientUnaryCall;
