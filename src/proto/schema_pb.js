...
goog.exportSymbol('proto.immudb.schema.Ops', null, global);
 ...
 * @constructor
 */
proto.immudb.schema.Ops = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.immudb.schema.Ops.repeatedFields_, null);
};
goog.inherits(proto.immudb.schema.Ops, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.immudb.schema.Ops.displayName = 'proto.immudb.schema.Ops';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.immudb.schema.Op.toObject = function(includeInstance, msg) {
  var f, obj = {
    kvs: (f = msg.getKvs()) && proto.immudb.schema.KeyValue.toObject(includeInstance, f),
    zopts: (f = msg.getZopts()) && proto.immudb.schema.ZAddOptions.toObject(includeInstance, f),
    ropts: (f = msg.getRopts()) && proto.immudb.schema.ReferenceOptions.toObject(includeInstance, f)
  };
...
/**
 * optional KeyValue KVs = 1;
 * @return {?proto.immudb.schema.KeyValue}
 */
proto.immudb.schema.Op.prototype.getKvs = function() {
...
*/
proto.immudb.schema.Op.prototype.setKvs = function(value) {
 ...
 * @return {!proto.immudb.schema.Op} returns this
 */
proto.immudb.schema.Op.prototype.clearKvs = function() {
  return this.setKvs(undefined);
};
 ...
 * @return {boolean}
 */
proto.immudb.schema.Op.prototype.hasKvs = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional ZAddOptions ZOpts = 2;
 * @return {?proto.immudb.schema.ZAddOptions}
 */
proto.immudb.schema.Op.prototype.getZopts = function() {
  return /** @type{?proto.immudb.schema.ZAddOptions} */ (
    jspb.Message.getWrapperField(this, proto.immudb.schema.ZAddOptions, 2));
};
 ...
 * @return {!proto.immudb.schema.Op} returns this
*/
proto.immudb.schema.Op.prototype.setZopts = function(value) {
 ...
 * @return {!proto.immudb.schema.Op} returns this
 */
proto.immudb.schema.Op.prototype.clearZopts = function() {
 ...
 * @return {boolean}
 */
proto.immudb.schema.Op.prototype.hasZopts = function() {
  return jspb.Message.getField(this, 2) != null;
};


/**
 * optional ReferenceOptions ROpts = 3;
 * @return {?proto.immudb.schema.ReferenceOptions}
 */
proto.immudb.schema.Op.prototype.getRopts = function() {
  return /** @type{?proto.immudb.schema.ReferenceOptions} */ (
    jspb.Message.getWrapperField(this, proto.immudb.schema.ReferenceOptions, 3));
};
 ...
 * @return {!proto.immudb.schema.Op} returns this
*/
proto.immudb.schema.Op.prototype.setRopts = function(value) {
 ...
 * @return {!proto.immudb.schema.Op} returns this
 */
proto.immudb.schema.Op.prototype.clearRopts = function() {
  return this.setRopts(undefined);
};
 ...
 * @return {boolean}
 */
proto.immudb.schema.Op.prototype.hasRopts = function() {
 ...
 * @const
 */
proto.immudb.schema.Ops.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.immudb.schema.Ops.prototype.toObject = function(opt_includeInstance) {
  return proto.immudb.schema.Ops.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.immudb.schema.Ops} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.immudb.schema.Ops.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.immudb.schema.Ops}
 */
proto.immudb.schema.Ops.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.immudb.schema.Ops;
  return proto.immudb.schema.Ops.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.immudb.schema.Ops} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.immudb.schema.Ops}
 */
proto.immudb.schema.Ops.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.immudb.schema.Ops.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.immudb.schema.Ops.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.immudb.schema.Ops} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.immudb.schema.Ops.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.immudb.schema.Ops.prototype.getOperationsList = function() {
 ...
 * @return {!proto.immudb.schema.Ops} returns this
*/
proto.immudb.schema.Ops.prototype.setOperationsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.immudb.schema.Op}
 */
proto.immudb.schema.Ops.prototype.addOperations = function(opt_value, opt_index) {
 ...
 * @return {!proto.immudb.schema.Ops} returns this
 */
proto.immudb.schema.Ops.prototype.clearOperationsList = function() {
 ...
 * @return {?proto.immudb.schema.Index}
 */
proto.immudb.schema.ReferenceOptions.prototype.getIndex = function() {
  return /** @type{?proto.immudb.schema.Index} */ (
    jspb.Message.getWrapperField(this, proto.immudb.schema.Index, 3));
};
 ...
 * @return {!proto.immudb.schema.ReferenceOptions} returns this
*/
proto.immudb.schema.ReferenceOptions.prototype.setIndex = function(value) {
 ...
 * @return {!proto.immudb.schema.ReferenceOptions} returns this
 */
proto.immudb.schema.ReferenceOptions.prototype.clearIndex = function() {
 ...
 * @return {boolean}
 */
proto.immudb.schema.ReferenceOptions.prototype.hasIndex = function() {
  return jspb.Message.getField(this, 3) != null;
};
