...
export class Op extends jspb.Message { 
    ...
    hasKvs(): boolean;
    clearKvs(): void;
    getKvs(): KeyValue | undefined;
    setKvs(value?: KeyValue): Op;


    hasZopts(): boolean;
    clearZopts(): void;
    getZopts(): ZAddOptions | undefined;
    setZopts(value?: ZAddOptions): Op;


    hasRopts(): boolean;
    clearRopts(): void;
    getRopts(): ReferenceOptions | undefined;
    setRopts(value?: ReferenceOptions): Op;
...
export namespace Op {
    export type AsObject = {
        kvs?: KeyValue.AsObject,
        zopts?: ZAddOptions.AsObject,
        ropts?: ReferenceOptions.AsObject,
    }
...
export class Ops extends jspb.Message { 
    clearOperationsList(): void;
    getOperationsList(): Array<Op>;
    setOperationsList(value: Array<Op>): Ops;
    addOperations(value?: Op, index?: number): Op;


    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): Ops.AsObject;
    static toObject(includeInstance: boolean, msg: Ops): Ops.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: Ops, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): Ops;
    static deserializeBinaryFromReader(message: Ops, reader: jspb.BinaryReader): Ops;
}
...
export class ReferenceOptions extends jspb.Message { 
    ...
    setIndex(value?: Index): ReferenceOptions;
